...
class FormattingRulesUpdatedConsumerTest {
    ...
    fun `onMessage should process formatting rules updated event successfully`() =
        runTest {
            ...
            Thread.sleep(100) // Give time for coroutine to execute
    ...
    fun `options should return correct poll timeout duration`() {
        ...
        // Then
        assertNotNull(options)
        // The poll timeout should be 30000ms as configured in the consumer
    }
    ...
    @Test
    fun `onComponentDestroy should cancel coroutine scope`() {
        // When
        consumer.onComponentDestroy()

        // Then - no exception should be thrown
        // The coroutine scope should be cancelled
        // This is verified by ensuring the method executes without throwing
    }
}
